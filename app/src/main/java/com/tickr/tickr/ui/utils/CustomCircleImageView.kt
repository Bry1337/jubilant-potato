...
/**
 * Created by bry1337 on 28/09/2017.
 *
 * @author edwardbryan.abergas@gmail.com
 */

class CustomCircleImageView : android.support.v7.widget.AppCompatImageView {
  ...
  @JvmOverloads constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs,
      defStyle) {
